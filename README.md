...
Update your app’s Android Manifest to add the following permissions:
...
```Java
dependencies {
    compile('com.fujifilmssd:fujifilm.spa.sdk:1.6.8')
}
```
...
```
Change your minimum SDK version to 16 or above to 16 in your gradle file: minSdkVersion 16
```Java
 minSdkVersion 16
```
